...
add wave -noupdate -expand -group dmem /testbench/proc/dmem/clk
add wave -noupdate -expand -group dmem /testbench/proc/dmem/reset_n
add wave -noupdate -expand -group dmem /testbench/proc/dmem/addr
add wave -noupdate -expand -group dmem /testbench/proc/dmem/op_rd_wr
add wave -noupdate -expand -group dmem /testbench/proc/dmem/op_en
add wave -noupdate -expand -group dmem /testbench/proc/dmem/wr_data
add wave -noupdate -expand -group dmem /testbench/proc/dmem/wr_keep
add wave -noupdate -expand -group dmem /testbench/proc/dmem/rd_data
add wave -noupdate -expand -group dmem /testbench/proc/dmem/wr_data_keep
add wave -noupdate -expand -group dmem /testbench/proc/dmem/mem_data
add wave -noupdate -expand -group dmem /testbench/proc/dmem/memory
...
update
WaveRestoreZoom {37531 ps} {81317 ps}
